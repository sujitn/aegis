...
impl CommunityRuleManager {
    ...
    fn aegis_curated_rules() -> Vec<CommunityRule> {
        ...
        vec![
            ...
            .with_severity(Severity::Strong)
            .with_tier(RuleTier::Curated),
            // Image generation explicit content patterns (F033)
            CommunityRule::new(
                "curated_imagegen_001",
                r"\b(generate|create|draw|make|render)\s+(a\s+)?(nude|naked|nsfw|porn|explicit|sexual)\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_002",
                r"\b(nude|naked|nsfw|explicit)\s+(image|photo|picture|art|drawing|render)\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_003",
                r"\b(hentai|rule\s*34|r34)\s*(style|art|image|of)?\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_004",
                r"\b(topless|bottomless|undressed|unclothed)\s*(woman|man|girl|boy|person|character)?\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_005",
                r"\b(erotic|provocative|seductive)\s*(pose|image|photo|art)\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_006",
                r"\bpornographic\s*(content|image|material|art)?\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_007",
                r"\b(genitalia|breasts?|nipples?|buttocks?)\s*(exposed|visible|showing)?\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_009",
                r"\b(lewd|risque|indecent)\s*(image|picture|drawing|art)?\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
            ...
            .with_tier(RuleTier::Curated),
            CommunityRule::new(
                "curated_imagegen_010",
                r"\bwithout\s+(clothes|clothing|underwear)\b",
                Category::Adult,
                source.clone(),
            )
            .with_regex()
